...
static char sccsid[] = "@(#)findiop.c	5.7 (Berkeley) 9/22/88";
...
#define NSTATIC	OPEN_MAX /* stdin + stdout + stderr + the usual */
...
FILE _iob[NSTATIC] = {
	{ 0, NULL, NULL, 0, _IOREAD|_IOTEXT,	0 },	/* stdin  */
	{ 0, NULL, NULL, 0, _IOWRT|_IOTEXT,	1 },	/* stdout */
	{ 0, NULL, NULL, 0, _IOWRT|_IONBF|_IOTEXT,2 },	/* stderr */
};
...
static int _f_morefiles();

static	char sbuf[NSTATIC];
char	*_smallbuf = sbuf;
static	FILE	**iobglue = NULL;
static	FILE	**endglue = NULL;
...
_f_morefiles()
{
	...
	iobglue = (FILE **)calloc(nfiles, sizeof (FILE *));
	if (iobglue == NULL)
		return (0);
